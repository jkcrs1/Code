...
library(dplyr)
# library(ggplot2)  # No usada
# library(lubridate)  # No usada
# library(scales)  # No usada
# library(prophet)  # No usada
library(stringr)
# library(caret)  # No usada
# library(corrplot)  # No usada
# library(e1071)  # No usada
# library(xgboost)  # No usada
# library(ROSE)  # No usada
# library(pROC)  # No usada
# library(factoextra)  # No usada
library(knitr)
library(kableExtra)
library(readxl)
library(summarytools)
# library(htmltools)  # No usada
...
p1 <- grafico(estudiantes_data, "Sexo", "torta")
p2 <- grafico(estudiantes_data, "Colegio", "anillo")
...
# Generar algunos gráficos
p1 <- grafico(estudiantes_data, "Ingreso", "boxplot")
p2 <- grafico(estudiantes_data, "Gastos", "boxplot")
p2 <- grafico(estudiantes_data, "Edad", "boxplot")
